...
public class WeatherUtils {
    ...
    private static final String API_KEY_OPEN_CAGE = "e2983827bb0548cd83cb556e7fa1be8d";
...
//        System.out.println(url);
    ...
    private static String getAddressFromLatLong(double lat, double lon) throws IOException {
        String apiKey = API_KEY_OPEN_CAGE; // 🔒 Replace this with your actual API key
        OkHttpClient client = new OkHttpClient();
...
//        System.out.println("Response from OpenCage: " + responseData); Debug
        JSONObject json = new JSONObject(responseData);
    ...
    public static String[] getCoordinates(String city) throws Exception {
        OkHttpClient client = new OkHttpClient();
        String url = BASE_URL_GEO + "?q=" + city + "&key=" + API_KEY_OPEN_CAGE;
