...
public class MainMenu {
    private static final List<String> option = Arrays.asList("Check Today Forecast", "Check Temperature",
            "Check Forecast of an City", "Check Dynamic Weather Current City", "Exit");
    ...
    public static void exec() {
        ...
        while (true) {
            ...
            try {
                Class<?> clazz = Class.forName("WeatherProject." + menuChosen);
    ...
    private static void genMenu() {
        String title = "FORECAST WEATHER MENU";
        int width = 30;
        int height = 5;
